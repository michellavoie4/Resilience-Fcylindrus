function u = FBAlight(param, model1)

% This function calculates the growth rate as a function of all parameters
% fixed in the model
% INPUTS : param : vector of parameters containing 65 numeric values
%
% OUTPUT : % gives the model growth rate (d-1)
...
DWcell = Ccell * 2.;  % Assume a g DW / g C = 2
...
Prop_glucan = param(54); %10.      % Proportion of cabohydrate as glucan accumulated at each time step
Prop_TAG = param(55); %10.          % Proportion of lipid accumulated as TAG at each time step
...
%[0.2884	0.1550 0.2475 0.0806 0.0340 0.0436 0.0794 0.0565 0.0201]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Check Objective function and calculate FBA
