...
# Script creating a bipartite network in F. cylindrus metabolism and calculating different properties
...
cwd = os.getcwd()
print(cwd)
# Need to add 'analyse_reseau_2.py" and "Table_bipartite.txt" in the working directory
# "Table_bipartite.txt" is produced by the file 'bipartite.m' in MATLAB

########
#run analyse_reseau_2.py
# This run a function and execute all the script as it was a main script
# exec(open("analyse_reseau_2.py").read())
# g
######

# Rather than execute directly different main script, I prefer to import the file as a module
import analyse_reseau_2

g = analyse_reseau_2.load_graph("Table_bipartite.txt")
